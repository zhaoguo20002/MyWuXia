...
namespace Game {
	...
	public partial class DbManager {
		...
		public void CreateAllDbs() {
            ...
            #region 初始化诀要相关数
            db.ExecuteQuery("create table if not exists BookExpsTable (Id integer primary key not null, BookPrivateId integer not null, BookId text not null, ExpData text not null, SecretsData text not null, BelongToRoleId text not null)");
