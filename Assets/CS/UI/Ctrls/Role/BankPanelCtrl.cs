...
namespace Game {
    public class BankPanelCtrl : WindowCore<BankPanelCtrl, JArray> {
		Image bg;
		Button block;
		Button closeBtn;
		...
		public static void Show() {
			if (Ctrl == null) {
                InstantiateView("Prefabs/UI/Role/BankPanelView", "BankPanelCtrl", 0, 0, UIModel.FrameCanvas.transform);
				Ctrl.Pop();
			}
		}
