	...
	public class WorkshopModel {
		...
		public static void Init() {
			if (Relationships == null) {
				...
				Relationships.Add(new ResourceRelationshipData(ResourceType.SilverOre, "3", new List<ResourceData>() { new ResourceData(ResourceType.Food, 10) }, 1, 20, 11, 12));
				...
				Relationships.Add(new ResourceRelationshipData(ResourceType.Silver, "3", new List<ResourceData>() { new ResourceData(ResourceType.SilverOre, 1) }, 11, 1.8f, 1, -1));
				...
				Relationships.Add(new ResourceRelationshipData(ResourceType.RedSteel, "3", new List<ResourceData>() { new ResourceData(ResourceType.Tungsten, 3), new ResourceData(ResourceType.Stone, 1) }, 1, 22.5f, 12.4f, 20));
				Relationships.Add(new ResourceRelationshipData(ResourceType.RefinedSteel, "3", new List<ResourceData>() { new ResourceData(ResourceType.Steel, 10) }, 1, 160, 88, 150));
				Relationships.Add(new ResourceRelationshipData(ResourceType.TungstenSteel, "3", new List<ResourceData>() { new ResourceData(ResourceType.Tungsten, 100) }, 1, 727.3f, 400, 600));
				Relationships.Add(new ResourceRelationshipData(ResourceType.Zingana, "3", new List<ResourceData>() { new ResourceData(ResourceType.Wood, 900), new ResourceData(ResourceType.TungstenSteel, 1) }, 1, 1327.3f, 730, 1500));
				Relationships.Add(new ResourceRelationshipData(ResourceType.DarksteelIngot, "3", new List<ResourceData>() { new ResourceData(ResourceType.Silver, 310) }, 1, 6200, 3410, 4500));
			}
		}
	}
}
