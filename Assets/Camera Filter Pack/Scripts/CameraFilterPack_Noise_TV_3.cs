...
ChangeValue = Fade;
ChangeValue2 = Fade_Additive;
		ChangeValue3 = Fade_Distortion;
ChangeValue4 = Value4;
...
Graphics.Blit(sourceTexture, destTexture);
	...
	void OnValidate(){ChangeValue=Fade;ChangeValue2=Fade_Additive;ChangeValue3=Fade_Distortion;ChangeValue4=Value4;}void Update ()
{
if (Application.isPlaying)
{
Fade = ChangeValue;
			Fade_Additive = ChangeValue2;
			Fade_Distortion = ChangeValue3;
Value4 = ChangeValue4;
}
#if UNITY_EDITOR
